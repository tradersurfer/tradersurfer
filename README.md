...
📐 **[100-year-flp](https://github.com/tradersurfer/100-year-flp)** — The 100-Year Family Elevation Plan: FLP structure, equity distribution ladders, subsidiary roadmaps, and generational milestone targets across a six-person dynasty framework. A working document, not a vision board.
...
- 📊 [jeci-signal-dashboard](https://github.com/tradersurfer/jeci-signal-dashboard) — Live React dashboard: SPY state banner, consensus strip, tier tables, integrated AI chat panel
- 🧠 [tri-agent-consensus](https://github.com/tradersurfer/tri-agent-consensus) — Grok (sentiment) / Claude (technical bias) / Gemini (Chief Risk Officer) voting network
- 🛡️ [master-risk-moat](https://github.com/tradersurfer/master-risk-moat) — Hardcoded guardrails: premium caps, RSI lockouts, DTE floors, re-entry blocklist. LLMs never touch this layer.
- 🌊 [market-state-engine](https://github.com/tradersurfer/market-state-engine) — Programmatic intraday regime detector: BULL_TRAP / WATERFALL / V_BOTTOM on SPY 15m data
...
- 📄 **PSPDFKit for me** — BA Accounting, Gardner-Webb University · In Bitcoin since 2016
...
[X / Twitter](https://x.com/AdrianJordan) · [Instagram](https://instagram.com/adrianjordan.io) · [TikTok](https://tiktok.com/BitcoinAdrian) · [Substack](https://substack.com/@adrianjordanio) · [LinkedIn](https://linkedin.com)

---

## Philosophy

> *Systems beat hustle. A machine you understand well enough to automate runs while you sleep. A strong man working hard doesn't scale.*

BA Accounting. In Bitcoin since 2016. Former GM who took a store from #548 to Top 100 nationally. I build tools that automate what I already understand deeply — trading, credit, accounting, real estate. Every repo here is a bet that I know the system well enough to encode it.

JECI Group exists because financial sovereignty isn't a mindset — it's an architecture.
